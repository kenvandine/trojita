...
Page {
        ...
        Item {
            ...
            Column {
                ...
                Label {
                    ...
                    color: !col.visible ? "blue" :
                                          model.isMarkedRead ?
                                              (model.isMarkedDeleted ? "grey" : "black") :
                                              "red"
    ...
    Component {
        ...
        Loader {
            sourceComponent: view.count >0 && (view.massiveScrolling || view.verticalVelocity > 2000) ? scrollingMessageDelegate: normalMessageItemDelegate
